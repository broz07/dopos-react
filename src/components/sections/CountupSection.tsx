...
const CountupSection = () => {
	...
	return (
		...
		>
			...
			>
				<Count text="rok založení" end={2007} separator=" " className={countUpClass}/>
				<Count text="staveb" end={20} separator="," prefix="Přes " className={countUpClass}/>
				<Count text="let zkušeností" end={30} prefix="" className={countUpClass}/>
			</Parallax>
		</div>
	);
};
